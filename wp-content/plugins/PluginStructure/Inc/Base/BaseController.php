...
namespace Inc\Base;
   ...
   class BaseController extends WP_Widget
{

	public function __construct() {
        //$this->WP_Widget($id_base, $name, $widget_options);
        parent::__construct('css_id'  , 'my first widget', array("classname" => "Class-widget", "description" => "Descripción del widget"));
    }

    // Creamos el cuerpo del widget
    public function form($instance){
        $defaults=array("titulo"=>"Hello world");
